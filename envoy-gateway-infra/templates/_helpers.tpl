...
Chart name
*/}}
{{- define "envoy-gateway-infra.name" -}}
...
Chart label value
*/}}
{{- define "envoy-gateway-infra.chart" -}}
...
*/}}
{{- define "envoy-gateway-infra.namespace" -}}
{{- $resource := index . 0 -}}
{{- $ctx     := index . 1 -}}
...
Common labels
*/}}
{{- define "envoy-gateway-infra.labels" -}}
helm.sh/chart: {{ include "envoy-gateway-infra.chart" . }}
...
*/}}
{{- define "envoy-gateway-infra.annotations" -}}
...
*/}}
{{- define "envoy-gateway-infra.parentRef" -}}
- name: {{ .name }}
  {{- with .namespace }}
  namespace: {{ . }}
  {{- end }}
...
*/}}
{{- define "envoy-gateway-infra.backendRefs" -}}
{{- range . }}
- name: {{ .name }}
  {{- with .namespace }}
  namespace: {{ . }}
...
*/}}
{{- define "envoy-gateway-infra.httpFilters" -}}
{{- range . }}
- type: {{ .type }}
